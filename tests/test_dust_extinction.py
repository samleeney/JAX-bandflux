...
def test_salt3_with_different_dust_laws():
    ...
    # Test with CCM89 dust law
    params_ccm89 = base_params.copy()
    params_ccm89['dust_type'] = 0  # 0 = CCM89
    ...
    # Test with OD94 dust law
    params_od94 = base_params.copy()
    params_od94['dust_type'] = 1  # 1 = OD94
    ...
    # Test with F99 dust law
    params_f99 = base_params.copy()
    params_f99['dust_type'] = 2  # 2 = F99
